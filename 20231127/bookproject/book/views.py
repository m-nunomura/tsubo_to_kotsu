...
def index(request):
    ...
    paginator = Paginator(ranking_list,consts.ITEM_PER_PAGE)
    page_number = request.GET.get("page",1)
    page_obj = paginator.page(page_number)
    return render(request,"book/book_index.html",{"object_list":object_list,"ranking_list":ranking_list,"page_obj":page_obj})
